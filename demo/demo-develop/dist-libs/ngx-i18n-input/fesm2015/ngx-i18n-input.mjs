...
const NGX_I18N_INPUT_DEFAULT_CONFIGS = {
    ...
    stringifyLang: (lang) => {
        ...
        return ((_a = LANGUAGE_DETAILS[lang]) === null || _a === void 0 ? void 0 : _a.i18nName) || lang;
    }
};
// TODO partial ??
...
class NgxI18nInputService {
    constructor() {
        ...
        this.configs$ = new BehaviorSubject(Object.assign({}, (this.providedConfigs || NGX_I18N_INPUT_DEFAULT_CONFIGS)));
            ...
            providers: [
                {
                    ...
                    useValue: Object.assign(Object.assign({}, NGX_I18N_INPUT_DEFAULT_CONFIGS), configs)
                }
            ]
        };
    }
